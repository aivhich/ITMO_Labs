...
CREATE TYPE EventType 
  AS ENUM ('meeting', 'conversation', 'journey', 'battle', 'celebration',
  'accident', 'ritual', 'discovery', 'creation', 'destruction');
CREATE TYPE ObjectType 
  AS ENUM ('tool', 'weapon', 'building', 'vehicle', 'artifact', 'natural',
  'document', 'clothing', 'food', 'furniture');
CREATE TYPE ParticipateRole 
  AS ENUM ('organizer', 'participant', 'witness', 'victim', 'protagonist',
  'antagonist', 'helper', 'bystander', 'initiator', 'leader');
CREATE TYPE EmotionType 
  AS ENUM ('joy', 'sadness', 'anger', 'fear', 'surprise', 'disgust');
